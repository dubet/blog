...
Ces parties de l'API sont réservées à certaines entités spécifiques plus *privilégiées*, ayant les propriétés nécessaires en fonction du type de contrôles d'accès:
